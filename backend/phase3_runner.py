...
prints a formatted summary. Supports local SQLite or Supabase cloud.
...
def run_phase3(force: bool = False, user_id: str = None) -> dict:
    ...
    # Run the alert cycle
    summary = run_alert_cycle(force=force, user_id=user_id)
